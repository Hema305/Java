...
public class MoneyMoneyBankTest {
	...
	public void currentAccountNegative() {
		...
		MMCurrentAccount mmCurrentAccount= (MMCurrentAccount)mmBankFactory.getNewCurrentAccount("Hema",0,50000);
		try {
	...
	public void savingsAccount() {
		BankFactory mmBankFactory=new MMBankFactory();
		MMSavingsAccount mmSavingsAccount = (MMSavingsAccount)mmBankFactory.getNewSavingsAccount("Latha",0,true);
		try {
